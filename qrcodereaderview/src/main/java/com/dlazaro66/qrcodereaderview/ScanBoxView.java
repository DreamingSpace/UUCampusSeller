...
public class ScanBoxView extends View {
    ...
    public ScanBoxView(Context context) {
        ...
        mMaskColor = Color.parseColor("#60000000");
        mCornerColor = Color.parseColor("#76EE00");
        mCornerLength = DisplayUtils.dp2px(context, 20);
        mCornerSize = DisplayUtils.dp2px(context, 4);
        mScanLineSize = DisplayUtils.dp2px(context, 2);
        mCornerColor = Color.parseColor("#76EE00");
